<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="detail.aspx.cs" Inherits="rtwin.detail" title="Sistem Kehadiran Kerja Pegawai Kementerian Sekretariat Negara Republik Indonesia" Culture="auto:id-ID" UICulture="auto" %>
...
<asp:ValidationSummary id="ValidationSummary1" runat="server" CssClass="fontR" EnableClientScript="True"></asp:ValidationSummary><asp:Label id="ExceptionDetails" runat="server" CssClass="fontR" SkinID="fontR" EnableViewState="False"></asp:Label><TABLE class="border_table" cellSpacing=0 cellPadding=0 width="100%"><TBODY><TR><TD style="WIDTH: 100%"><BR /><TABLE cellSpacing=0 cellPadding=0 width=750><TBODY><TR><TD style="WIDTH: 200px" vAlign=top align=left><asp:RadioButton id="radTanggal" runat="server" Visible="False" Text="<%$ Resources:lblTanggal %>" GroupName="waktu"></asp:RadioButton></TD><TD style="WIDTH: 150px" vAlign=top align=left><asp:TextBox id="txtFilterItem0" runat="server" Visible="False" width="100px" MaxLength="10" Columns="10"></asp:TextBox>&nbsp;<asp:ImageButton id="imgFilterItem0" runat="server" Visible="False" CausesValidation="False" ImageUrl="~/images/ew_calendar.gif"></asp:ImageButton> <asp:RequiredFieldValidator id="valFilterItem0" runat="server" CssClass="fontR" SkinID="fontR" ErrorMessage="<%$ Resources:Resource, lblFieldCannotEmpty %>" ControlToValidate="txtFilterItem0" EnableClientScript="True" SetFocusOnError="True">*</asp:RequiredFieldValidator><asp:CompareValidator id="valFilterItem0_1" runat="server" CssClass="fontR" SkinID="fontR" ErrorMessage="<%$ Resources:Resource, salahValidatorTanggal %>" ControlToValidate="txtFilterItem0" EnableClientScript="True" ValueToCompare="01/01/1900" Type="Date" Operator="GreaterThanEqual" meta:resourceKey="CompareValTglAwal">*</asp:CompareValidator><cc1:calendarextender id="cexFilterItem0" runat="server" cssclass="cal_Theme1" enabled="True" format="<%$ Resources:Resource, formatTanggal %>" popupbuttonid="imgFilterItem0" targetcontrolid="txtFilterItem0"> </cc1:calendarextender> <cc1:MaskedEditExtender id="mexFilterItem0" runat="server" Mask="99/99/9999" MaskType="Date" TargetControlID="txtFilterItem0"></cc1:MaskedEditExtender></TD><TD style="WIDTH: 50px" vAlign=top align=center><asp:Label id="lblTo" runat="server" Visible="False" Text="<%$ Resources:lblTglAkhir %>"></asp:Label></TD><TD style="WIDTH: 150px" vAlign=top align=left><asp:TextBox id="txtFilterItem1" runat="server" Visible="False" width="100px" MaxLength="10" Columns="10"></asp:TextBox>&nbsp;<asp:ImageButton id="imgFilterItem1" runat="server" Visible="False" CausesValidation="False" ImageUrl="~/images/ew_calendar.gif"></asp:ImageButton> <asp:RequiredFieldValidator id="valFilterItem1" runat="server" CssClass="fontR" SkinID="fontR" ErrorMessage="<%$ Resources:Resource, lblFieldCannotEmpty %>" ControlToValidate="txtFilterItem1" EnableClientScript="True" SetFocusOnError="True">*</asp:RequiredFieldValidator><asp:CompareValidator id="valFilterItem1_1" runat="server" CssClass="fontR" SkinID="fontR" ErrorMessage="<%$ Resources:Resource, salahValidatorTanggal %>" ControlToValidate="txtFilterItem1" EnableClientScript="True" ValueToCompare="01/01/1900" Type="Date" Operator="GreaterThanEqual" meta:resourceKey="CompareValTglAwal">*</asp:CompareValidator><asp:CompareValidator id="valFilterItem1_2" runat="server" CssClass="fontR" SkinID="fontR" ErrorMessage="<%$ Resources:CompareValTglAkhir %>" ControlToValidate="txtFilterItem1" EnableClientScript="True" Type="Date" Operator="GreaterThanEqual" meta:resourceKey="CompareValTglAkhir" ControlToCompare="txtFilterItem0">*</asp:CompareValidator><cc1:calendarextender id="cexFilterItem1" runat="server" cssclass="cal_Theme1" enabled="True" format="<%$ Resources:Resource, formatTanggal %>" popupbuttonid="imgFilterItem1" targetcontrolid="txtFilterItem1"> </cc1:calendarextender> <cc1:MaskedEditExtender id="mexFilterItem1" runat="server" Mask="99/99/9999" MaskType="Date" TargetControlID="txtFilterItem1"></cc1:MaskedEditExtender></TD><TD style="WIDTH: 200px" vAlign=top align=left>&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;</TD></TR><TR><TD vAlign=top align=left><asp:RadioButton id="radBulan" runat="server" Text="<%$ Resources:lblBulan %>" GroupName="waktu" Checked="True"></asp:RadioButton></TD><TD vAlign=top align=left><asp:DropDownList id="DropBulan" runat="server">
                    ...
                    </asp:DropDownList></TD><TD vAlign=top align=left></TD></TR><TR><TD vAlign=top align=left colSpan=5><asp:Label id="lblType" runat="server" Font-Bold="True" Text="<%$ Resources:lblType %>" Font-Size="Small"></asp:Label></TD></TR><TR><TD colSpan=9><DIV style="WIDTH: 400px; HEIGHT: 200px" id="scrollvertical"><asp:RadioButtonList id="rblReportType" runat="server">
            </asp:RadioButtonList></DIV> </TD></TR></TBODY></TABLE><BR /><DIV id="hide" runat="server"><TABLE cellSpacing=0 cellPadding=0 width=1000 border=0><TBODY><TR style="FONT-SIZE: 12pt"><TD style="WIDTH: 200px"><asp:Label id="lblFilter" runat="server" Font-Bold="True" Text="<%$ Resources:lblFilter %>" Font-Size="Small"></asp:Label></TD><TD style="WIDTH: 800px" colSpan=3></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:Label id="lblNIP" runat="server" Text="<%$ Resources:cbNIP %>"></asp:Label><asp:Label id="lblPIN" runat="server" Text="PIN"></asp:Label></TD><TD colSpan=3><asp:TextBox id="txtFilterNIP" runat="server" Text='<%# Bind("NIP") %>' width="100px"></asp:TextBox> <asp:LinkButton id="lnkFilterNIP" onclick="lnkFilterNIP_Click" runat="server" CausesValidation="False">Lookup</asp:LinkButton></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:Label id="lblInstansi" runat="server" Text="<%$ Resources:CbInstansi %>"></asp:Label></TD><TD colSpan=3><asp:DropDownList id="ddlInstansi" runat="server" AutoPostBack="True">
            </asp:DropDownList></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:Label id="lblUnit" runat="server" Text="<%$ Resources:cbUnit %>"></asp:Label></TD><TD colSpan=3><asp:DropDownList id="ddlUnit" runat="server" AutoPostBack="True">
            </asp:DropDownList></TD></TR><TR style="FONT-SIZE: 12pt"><TD style="HEIGHT: 18px"><asp:Label id="lblDeputi" runat="server" Text="<%$ Resources:cbDeputi %>"></asp:Label></TD><TD style="HEIGHT: 18px" colSpan=3><asp:DropDownList id="ddlDeputi" runat="server" AutoPostBack="True">
            </asp:DropDownList></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:Label id="lblBiro" runat="server" Text="<%$ Resources:CbBiro %>"></asp:Label></TD><TD colSpan=3><asp:DropDownList id="ddlBiro" runat="server" AutoPostBack="True">
            </asp:DropDownList></TD></TR><TR><TD><asp:Label id="lblBagian" runat="server" Text="<%$ Resources:cbBagian %>"></asp:Label></TD><TD colSpan=3><asp:DropDownList id="ddlBagian" runat="server" AutoPostBack="True">
            </asp:DropDownList></TD></TR><TR><TD><asp:Label id="lblSubbagian" runat="server" Text="<%$ Resources:cbSubbagian %>"></asp:Label>&nbsp;</TD><TD colSpan=3><asp:DropDownList id="ddlSubbagian" runat="server">
            </asp:DropDownList></TD></TR><TR><TD><asp:Label id="lblJabatan" runat="server" Text="<%$ Resources:cbJabatan %>"></asp:Label>&nbsp;</TD><TD colSpan=3><asp:DropDownList id="ddlJabatan" runat="server">
            ...
            </asp:DropDownList></TD></TR><TR style="FONT-SIZE: 12pt"><TD>&nbsp;</TD><TD colSpan=3></TD></TR><TR style="FONT-SIZE: 12pt"><TD colSpan=4><DIV id="hideAdmin2" runat="server"><TABLE width=500><!-- dari sini --><TBODY><TR style="FONT-SIZE: 12pt"><TD style="WIDTH: 200px"><asp:Label id="lblKriteria" runat="server" Font-Bold="True" Text="<%$ Resources:lblKriteria %>" Font-Size="Small"></asp:Label></TD><TD style="WIDTH: 300px" colSpan=3><asp:Label id="lblJenisIjin" runat="server" Font-Bold="True" Text="<%$ Resources:lblJenisIjin %>" Font-Size="Small"></asp:Label></TD></TR><TR style="FONT-SIZE: 12pt"><TD style="WIDTH: 200px"><DIV id="hideScroll1" runat="server"><asp:CheckBoxList id="cblKriteria" runat="server" width="190px" height="200px" CellSpacing="0" CellPadding="0"><asp:ListItem Value="H">Hadir Normal</asp:ListItem>
...
</asp:CheckBoxList> </DIV></TD><TD colSpan=3><DIV id="hideScroll" runat="server"><DIV style="WIDTH: 300px; HEIGHT: 200px" id="scrollvertical"><asp:CheckBoxList id="cblKodeIjin" runat="server" CellSpacing="0" CellPadding="0" RepeatColumns="1"></asp:CheckBoxList> </DIV></DIV></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:Button id="btnAllKriteria" onclick="btnAllKriteria_Click" runat="server" Text="<%$ Resources:btnAll %>" CausesValidation="False" width="61px"></asp:Button>&nbsp; <asp:Button id="btnClearKriteria" onclick="btnClearKriteria_Click" runat="server" Text="<%$ Resources:btnClear %>" CausesValidation="False" width="53px"></asp:Button></TD><TD vAlign=top align=left colSpan=3><asp:Button id="btnAllKodeIjin" onclick="btnAllKodeIjin_Click" runat="server" Text="<%$ Resources:btnAll %>" CausesValidation="False" width="59px"></asp:Button>&nbsp; <asp:Button id="btnClearKodeIjin" onclick="btnClearKodeIjin_Click" runat="server" Text="<%$ Resources:btnClear %>" CausesValidation="False" width="55px"></asp:Button></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:RadioButtonList id="rblOperand" runat="server" Visible="False" RepeatDirection="Horizontal"><asp:ListItem>And</asp:ListItem>
<asp:ListItem Selected="True">Or</asp:ListItem>
</asp:RadioButtonList>&nbsp;</TD><TD colSpan=3></TD></TR></TBODY></TABLE></DIV></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:Label id="Label1" runat="server" Font-Bold="True" Text="<%$ Resources:lblSort %>" Font-Size="Small"></asp:Label></TD><TD colSpan=3></TD></TR><TR style="FONT-SIZE: 12pt"><TD><asp:RadioButtonList id="rblSort" runat="server">
                    <asp:ListItem Value="KODE_GOLONGAN DESC, NIP" Selected="True" Text="<%$ Resources:cbGrade %>"></asp:ListItem>
