...
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="50%" cellpadding="3" id="tableFilter" style="font-size:12px">
    <tr>
        <td>Bulan</td>
        <td>:</td>
    ...
    <br />
     <table width="50%" cellpadding="3" id="tblForm" style="font-size:12px">
                <tr>
                    <td>NAMA</td>
                    <td>:</td>
    ...
    <table border="0" cellpadding="0" class="border_table" cellspacing="0" width="95%">
        <tr>
            <td align="left" style="width: 90%">
               ...
               <p>  <a href="#" class="btn btn-primary btn-sm"  id="tambahWfh">Tambah </a>  <a href="#" class="btn btn-primary btn-sm"  id="SimpanWfh">Simpan </a> &nbsp;&nbsp;&nbsp;<a href="#" class="btn btn-primary btn-sm"  id="cancel">Cancel </a>
							 ...
							 <table class="table" id="tblWFH" width="100%" style="font-size:12px">
                        <thead>
                           <tr>
                              <th>NIK</th>
                              <th>NAMA</th>
            ...
            .data("ui-autocomplete")._renderItem = function (ul, item) {
                        ...
                        { "data": "STATUS_JADWAL", "orderable": false },
                         {
                             ...
                             render: function (data, type, row) {
                                 return '<a href="#" class="btn btn-primary btn-sm"  tgledit = "'+row.NEW_DATE+'"    nip="' + row.NIP + '" nama="' + row.NAMA + '" golongan="' + row.NAMA_GOLONGAN + '" jabatan="' + row.JABATAN + '" jadwal ="' + row.JADWAL_WFH + '" tahun="' + row.TAHUN + '" bulan="' + row.BULAN + '">Edit  </a>&nbsp;<a href="#" class="btn btn-danger btn-sm"  tahun="' + row.TAHUN + '" nip="' + row.NIP + '" bulan="' + row.BULAN + '">Delete <i class="icon-remove"></i></a>'
                             }
              ...
              $("#prosesWfh").click(function () {
                  ...
                  $.ajax({
                      ...
                      //dataType: "json",
                      success: function (data) {
                           alert("Jadwal WFH berhasil di proses.");
              ...
              $("#SimpanWfh").click(function () {
                  ...
                  $.ajax({
                      ...
                      //dataType: "json",
                      success: function (data) {
                           alert("Jadwal WFH "+nip+" berhasil disimpan.");
						   
                          $('#tblWFH').DataTable().ajax.reload();
                      }
                  });
				   $("#jadwalWfh").datepicker('setDate', null);
              ...
              $('#tblWFH').on("click", "a.btn.btn-primary.btn-sm", function () {
                  ...
                  $("#namaPegawaiInputEdit").val(nama);
					...
					$.each(array, function(k, v){
						...
						var ndg = [parseInt(ndy), parseInt(ndm)+1, parseInt(ndd)];
					 myDate.push(new Date(ndg));
					 
					});
				 
					$('#jadwalWfh').datepicker('setDates', myDate);
