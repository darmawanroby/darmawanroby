<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="summary_daily.aspx.cs" Inherits="rtwin.summary_daily" title="Sistem Informasi Kehadiran Kerja Pegawai Kementerian Sekretariat Negara Republik Indonesia" Culture="auto:id-ID" UICulture="auto" %>
...
</asp:RadioButtonList></TD><TD colSpan=1></TD></TR></TBODY></TABLE></DIV></TD></TR><TR><TD><BR /><asp:Label id="Label1" runat="server" Font-Bold="True" Text="<%$ Resources:lblSort %>" Font-Size="Small" Visible="False"></asp:Label></TD><TD colSpan=1></TD></TR><TR><TD><asp:RadioButtonList id="rblSort" runat="server" Visible="False">
                    <asp:ListItem Value="KODE_GOLONGAN DESC, NIP" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="NIP"></asp:ListItem>
                    <asp:ListItem Value="Nama, NIP"></asp:ListItem>
                    <asp:ListItem Value="KODE_UNIT, NIP"></asp:ListItem>
                    <asp:ListItem Value="KODE_BIRO, NIP"></asp:ListItem>
