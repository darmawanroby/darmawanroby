<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="division.aspx.cs" Inherits="rtwin.division" title="Sistem Informasi Kehadiran Kerja Pegawai Kementerian Sekretariat Negara Republik Indonesia"  Culture="auto:id-ID" UICulture="auto" %>
...
<ItemTemplate>
<asp:Label id="lblCol0Item" runat="server" Text='<%# Bind("KODE_BAGIAN") %>' __designer:wfdid="w30"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField SortExpression="NAMA_BAGIAN" HeaderText="<%$ Resources:Column1 %>"><EditItemTemplate>
<asp:TextBox id="txtCol1Edit" runat="server" Text='<%# Bind("NAMA_BAGIAN") %>' __designer:wfdid="w267" Columns="30" MaxLength="90"></asp:TextBox> <asp:RequiredFieldValidator id="valCol1Edit" runat="server" ErrorMessage="<%$ Resources:Resource, lblFieldCannotEmpty %>" ControlToValidate="txtCol1Edit" __designer:wfdid="w37" SetFocusOnError="True" EnableClientScript="True">*</asp:RequiredFieldValidator> 
</EditItemTemplate>
<FooterTemplate>
<asp:TextBox id="txtCol1Footer" runat="server" __designer:wfdid="w38" Columns="30" MaxLength="90"></asp:TextBox> <asp:RequiredFieldValidator id="valCol1Footer" runat="server" ErrorMessage="<%$ Resources:Resource, lblFieldCannotEmpty %>" ControlToValidate="txtCol1Footer" __designer:wfdid="w39" SetFocusOnError="True" EnableClientScript="True">*</asp:RequiredFieldValidator>&nbsp; 
</FooterTemplate>

<HeaderStyle width="300px"></HeaderStyle>
<ItemTemplate>
<asp:Label id="lblCol1Item" runat="server" Text='<%# Bind("NAMA_BAGIAN") %>' __designer:wfdid="w266"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField SortExpression="NAMA_BIRO" HeaderText="<%$ Resources:Column2 %>"><EditItemTemplate>
<asp:DropDownList id="ddlCol2Edit" runat="server" DataSourceID="dsBiro" __designer:wfdid="w278" DataTextField="NAMA_BIRO" DataValueField="KODE_BIRO" SelectedValue='<%# Bind("KODE_BIRO") %>'></asp:DropDownList> 
</EditItemTemplate>
<FooterTemplate>
<asp:DropDownList id="ddlCol2Footer" runat="server" DataSourceID="dsBiro" __designer:wfdid="w279" DataTextField="NAMA_BIRO" DataValueField="KODE_BIRO"></asp:DropDownList> 
</FooterTemplate>

<HeaderStyle width="150px"></HeaderStyle>
<ItemTemplate>
<asp:Label id="lblCol2Item" runat="server" Text='<%# Bind("NAMA_BIRO") %>' __designer:wfdid="w277"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
</asp:GridView><asp:SqlDataSource id="dsDivision" runat="server" __designer:wfdid="w4" ConnectionString="<%$ ConnectionStrings:strCn %>" SelectCommand="SELECT KODE_BAGIAN, NAMA_BAGIAN, KODE_BIRO, NAMA_BIRO, KODE_DEPUTI, KODE_UNIT, KODE_INSTANSI, KODE_CABANG FROM q_Bagian ORDER BY KODE_BAGIAN" OnUpdated="dsBagian_Updated" OnDeleted="dsBagian_Deleted" OnInserted="dsBagian_Inserted" OnInserting="dsBagian_Inserting" DeleteCommand="DELETE FROM taBagian WHERE (KODE_BAGIAN = @KODE_BAGIAN)" InsertCommand="INSERT INTO taBagian(KODE_BAGIAN, NAMA_BAGIAN, KODE_BIRO) VALUES (@KODE_BAGIAN, @NAMA_BAGIAN, @KODE_BIRO)" UpdateCommand="UPDATE taBagian SET NAMA_BAGIAN = @NAMA_BAGIAN, KODE_BIRO = @KODE_BIRO WHERE (KODE_BAGIAN = @KODE_BAGIAN)"><DeleteParameters>
<asp:Parameter Name="KODE_BAGIAN"></asp:Parameter>
</DeleteParameters>
<UpdateParameters>
<asp:Parameter Name="NAMA_BAGIAN"></asp:Parameter>
...
</asp:SqlDataSource> <asp:SqlDataSource id="dsBiroFilter" runat="server" __designer:wfdid="w29" ConnectionString="<%$ ConnectionStrings:strCn %>" SelectCommand="SELECT [KODE_BIRO], [NAMA_BIRO] FROM [taBiro]"></asp:SqlDataSource> <asp:SqlDataSource id="dsDeputiFilter" runat="server" __designer:wfdid="w3" ConnectionString="<%$ ConnectionStrings:strCn %>" SelectCommand="SELECT [KODE_DEPUTI], [NAMA_DEPUTI] FROM [taDeputi]"></asp:SqlDataSource><asp:SqlDataSource id="dsUnitFilter" runat="server" __designer:wfdid="w3" ConnectionString="<%$ ConnectionStrings:strCn %>" SelectCommand="SELECT [KODE_UNIT], [NAMA_UNIT] FROM [taUnit]"></asp:SqlDataSource><asp:FormView id="FvBagian" runat="server" DataSourceID="dsDivision" DataKeyNames="KODE_BAGIAN" OnItemCommand="FvBagian_ItemCommand" EmptyDataText="<%$ Resources:lblEmptyData %>"><InsertItemTemplate>
<table style="WIDTH: 600px; BORDER-COLLAPSE: collapse" cellspacing="0" cellpadding="2" border="1"><tbody><tr><td style="WIDTH: 100px" class="HeaderStyle" align="center"><asp:Label id="Label1" runat="server" Text="<%$ Resources:Column0 %>" forecolor="Yellow" Font-Size="XX-Small" __designer:wfdid="w79"></asp:Label></td><td style="WIDTH: 300px" class="HeaderStyle" align="center"><asp:Label id="Label2" runat="server" Text="<%$ Resources:Column1 %>" forecolor="Yellow" Font-Size="XX-Small" __designer:wfdid="w80"></asp:Label></td><td style="WIDTH: 150px" class="HeaderStyle" align="center"><asp:Label id="Label3" runat="server" Text="<%$ Resources:Column2 %>" forecolor="Yellow" Font-Size="XX-Small" __designer:wfdid="w81"></asp:Label></td><td style="WIDTH: 50px" class="HeaderStyle"></td></tr><tr><td class="FooterStyle"><asp:TextBox id="txtCol0FormView" runat="server" Text='<%# Bind("KODE_BAGIAN") %>' __designer:wfdid="w82" MaxLength="6" Columns="6"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator id="valCol0FormView" runat="server" CssClass="fontR" forecolor="" ErrorMessage="<%$ Resources:Resource, lblFieldCannotEmpty %>" ControlToValidate="txtCol0FormView" __designer:wfdid="w83" SetFocusOnError="True" EnableClientScript="True">*</asp:RequiredFieldValidator></td><td class="FooterStyle"><asp:TextBox id="txtCol1FormView" runat="server" Text='<%# Bind("NAMA_BAGIAN") %>' __designer:wfdid="w84" MaxLength="90" Columns="30"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator id="valCol1FormView" runat="server" CssClass="fontR" forecolor="" ErrorMessage="<%$ Resources:Resource, lblFieldCannotEmpty %>" ControlToValidate="txtCol1FormView" __designer:wfdid="w85" SetFocusOnError="True" EnableClientScript="True">*</asp:RequiredFieldValidator></td><td class="FooterStyle"><asp:DropDownList id="ddlCol2FormView" runat="server" DataSourceID="dsBiro" __designer:wfdid="w337" DataValueField="KODE_BIRO" DataTextField="NAMA_BIRO" SelectedValue='<%# Bind("KODE_BIRO") %>'></asp:DropDownList></td><td class="FooterStyle"><asp:ImageButton id="imgInsert" runat="server" __designer:wfdid="w87" ImageUrl="~/Images/edit.gif" AlternateText="<%$ Resources:ImgInsert %>" CommandName="Insert"></asp:ImageButton>&nbsp;<asp:ImageButton id="imgCancelInsert" runat="server" CausesValidation="False" __designer:wfdid="w88" ImageUrl="~/Images/delete.gif" AlternateText="<%$ Resources:ImgCancel %>" CommandName="Cancel"></asp:ImageButton></td></tr></tbody></table>
</InsertItemTemplate>
</asp:FormView> 
</contenttemplate>
                </asp:UpdatePanel>
...
<asp:Panel style="Z-INDEX: 1; LEFT: 40%; POSITION: absolute; TOP: 60%" id="PNLProgress" runat="server" __designer:wfdid="w9"><table style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; HEIGHT: 75px" id="updateProgresstable" cellspacing="0" cellpadding="0" width="200"><tbody><tr><td class="headermessage" align="center"><asp:Label id="lblmessage" runat="server" SkinID="lblMessage" Text="Please wait..." __designer:wfdid="w10"></asp:Label> </td></tr><tr><td style="BACKGROUND-COLOR: #ffffff" align="center"><table id="table2" cellspacing="4" cellpadding="3" border="0"><tbody><tr><td><img id="imgProgress" alt="" src="images/loading.gif" runat="server" /></td></tr></tbody></table></td></tr><tr><td style="BACKGROUND-COLOR: #ffffff" valign="bottom" align="right"></td></tr></tbody></table></asp:Panel> 
                ...
                </asp:UpdateProgress><asp:SqlDataSource ID="dsBiro" runat="server" ConnectionString="<%$ ConnectionStrings:strCn %>"
                    SelectCommand="SELECT KODE_BIRO, NAMA_BIRO FROM taBiro WHERE KODE_BIRO <> '0000' ORDER BY KODE_BIRO">
                </asp:SqlDataSource>
