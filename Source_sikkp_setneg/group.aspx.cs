...
namespace rtwin
	{
		public partial class group : BasePage
		{
            ...
            {
                GvGolongan.Visible = show;
                FvGolongan.Visible = !show;
                if (show)
                {
                    FvGolongan.DefaultMode = FormViewMode.ReadOnly;
                }
            }
            ...
            protected void Page_Load(object sender, System.EventArgs e)
			{
                ...
                else
                {
                    ...
                    if ((!Page.IsPostBack) && (Session["GradeID"].ToString() != "1"))
                    {
                        ...
                        GvGolongan.Columns[6].Visible = false;
                        GvGolongan.Columns[7].Visible = false;
                    }
                }
			}
			...
			protected void GvGolongan_DataBound(object sender, System.EventArgs e)
			{
                ...
                if (GvGolongan.Rows.Count > 0)
                {
                    //Data tidak kosong
                    GridViewRow rowPager = GvGolongan.BottomPagerRow;
                    ...
                    if (rowPager != null)
                    {
                        ...
                        {
                            GvGolongan.PageIndex = GvGolongan.PageCount - 1;
                        }
                        ...
                        txtHalaman.Text = Convert.ToString(GvGolongan.PageIndex + 1);
                        lblJumlahHalaman.Text = GvGolongan.PageCount.ToString();
                    }
                    showGridView(true);
                }
                else
            ...
            protected void GvGolongan_RowEditing(object sender, GridViewEditEventArgs e)
            {
                if (Page.IsValid)
                {
                    GvGolongan.EditIndex = e.NewEditIndex;
                    GvGolongan.DataBind();
                    this.ScriptManager1.SetFocus(GvGolongan.Rows[e.NewEditIndex].Cells[1].FindControl("txtCol1Edit").ClientID);
                }
                else
                {
                    e.Cancel = true;
            ...
            protected void lnkBtnInsert_Click(object sender, EventArgs e)
            {
                if (Page.IsValid)
                {
                    ...
                    if (GvGolongan.Rows.Count > 0)
                    {
                        //Data tidak kosong
                        sendToLastPage = true;
                        GvGolongan.ShowFooter = true;
                        this.ScriptManager1.SetFocus(GvGolongan.FooterRow.Cells[0].FindControl("txtCol0Footer").ClientID);
                    }
                    else
                    {
                        //Data Kosong
                        FvGolongan.DefaultMode = FormViewMode.Insert;
                        this.ScriptManager1.SetFocus(FvGolongan.FindControl("txtCol0FormView"));
                    }
                }
            }
            ...
            protected void FvGolongan_ItemCommand(object sender, FormViewCommandEventArgs e)
            {
            ...
            protected void dsGolongan_Inserting(object sender, SqlDataSourceCommandEventArgs e)
            {
                ...
                if (GvGolongan.Rows.Count > 0)
                {
                    TextBox NewKode = (TextBox)GvGolongan.FooterRow.FindControl("txtCol0Footer");
                    TextBox NewNamaGolongan = (TextBox)GvGolongan.FooterRow.FindControl("txtCol1Footer");
                    TextBox NewTarifMakan = (TextBox)GvGolongan.FooterRow.FindControl("txtCol1aFooter");
                    TextBox NewTarifLembur = (TextBox)GvGolongan.FooterRow.FindControl("txtCol2Footer");
                    TextBox NewTarifMakanLembur = (TextBox)GvGolongan.FooterRow.FindControl("txtCol2aFooter");
                    TextBox NewPajakGolongan = (TextBox)GvGolongan.FooterRow.FindControl("txtCol3Footer");

                    e.Command.Parameters["@kode_golongan"].Value = NewKode.Text;
                    e.Command.Parameters["@nama_golongan"].Value = NewNamaGolongan.Text;
                    if (NewTarifMakan.Text.Trim() != "")
                    {
                        e.Command.Parameters["@tarif_makan"].Value = int.Parse(NewTarifMakan.Text);
                    }
                    if (NewTarifLembur.Text.Trim() != "")
                    {
                        e.Command.Parameters["@tarif_lembur"].Value = int.Parse(NewTarifLembur.Text);
                    }
                    if (NewTarifMakanLembur.Text.Trim() != "")
                    {
                        e.Command.Parameters["@tarif_uang_makan_lembur"].Value = int.Parse(NewTarifMakanLembur.Text);
                    }
                    if (NewPajakGolongan.Text.Trim() != "")
                    {
                        e.Command.Parameters["@PAJAK_GOLONGAN"].Value = int.Parse(NewPajakGolongan.Text);
                    }
                }
            }

            //fungsi: menghandle ketika datasource telah selesai melakukan proses insert
            protected void dsGolongan_Inserted(object sender, SqlDataSourceStatusEventArgs e)
            {
                ...
                else
                {
                    ...
                    azlib.AddUserAct(Session["UserID"].ToString(), "1291", e.Command.Parameters["@KODE_GOLONGAN"].Value.ToString(), Application["strCn"].ToString());
                }
                GvGolongan.ShowFooter = false;
                showGridView(true);
            }
            ...
            protected void dsGolongan_Deleted(object sender, SqlDataSourceStatusEventArgs e)
            {
                //seleksi apakah ada error (ditandai dengan jumlah baris yg terkena efek, 
                //jika = 0 / tidak ada yg terkena efek maka terjadi error)
                //jika tidak ada error / affectedRow > 0 maka lakukan penulisan log/userAct ke database
            ...
            protected void dsGolongan_Updated(object sender, SqlDataSourceStatusEventArgs e)
            {
                //seleksi apakah ada error (ditandai dengan jumlah baris yg terkena efek, 
                //jika = 0 / tidak ada yg terkena efek maka terjadi error)
                //jika tidak ada error / affectedRow > 0 maka lakukan penulisan log/userAct ke database
            ...
            protected void txtHalaman_TextChanged(object sender, System.EventArgs e)
            {
                ...
                try
                {
                    if (int.Parse(txtHalaman.Text) <= GvGolongan.PageCount + 1 && int.Parse(txtHalaman.Text) > 0)
                    {
                        GvGolongan.PageIndex = (int.Parse(txtHalaman.Text)) - 1;
                        GvGolongan.DataBind();
                    }
                }
                catch (Exception)
                {
                    txtHalaman.Text = (GvGolongan.PageIndex + 1).ToString();
                }
            }
}
}
