...
/****** Object:  Job [Proses_Upacara]    Script Date: 04/28/2021 09:26:40 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 04/28/2021 09:26:40 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Proses_Upacara', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [proses]    Script Date: 04/28/2021 09:26:40 ******/
...
BEGIN
  ...
  exec proc_UpdateStatusUpacara @dTglAwal, @dTglAkhir
END
